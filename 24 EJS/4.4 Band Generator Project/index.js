...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", {currYear: currentYear})
});
...
app.post("/submit", (req, res) => {
  ...
  const currentAdj = adj[Math.floor(Math.random() * adj.length)];
  const currentNoun = adj[Math.floor(Math.random() * noun.length)];
  const currentBandName = currentAdj + " " + currentNoun;
  res.render("index.ejs", {bandName: currentBandName, currYear: currentYear});
});
